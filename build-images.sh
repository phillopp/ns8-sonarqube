...
# --label="org.nethserver.images=docker.io/mariadb:10.11.18 docker.io/roundcube/roundcubemail:1.6.16-apache"
...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:15.10-alpine3.19 docker.io/sonarqube:2025.1.8-developer" \
    "${container}"
# Commit the image
